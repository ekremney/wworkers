(function() {
  ...
  window._satellite.container = {
    "buildInfo": {
      "buildDate": "2022-10-17T03:22:43Z",
      "turbineBuildDate": "2022-09-28T18:15:16Z",
      "turbineVersion": "27.4.0"
    },
    "environment": {
      "id": "ENf8447b17af6647fbac3af6aa969b6fa4",
      "stage": "staging"
    },
    "dataElements": {
      "Channel": {
        ...
        "settings": {
          "source": function(event) {
            ...
            if (_satellite.getVar("is BambooHR WWW Microsite"))
              channel = "www";
            else if (_satellite.getVar("is BambooHR Blog Microsite"))
              channel = "blog";
            else if (_satellite.getVar("is BambooHR Marketplace Microsite"))
              channel = "marketplace";
            else if (_satellite.getVar("is BambooHR Partners Microsite"))
              channel = "partners";
      ...
      "Blog Post Title": {
        ...
        "settings": {
          "path": "digitalData.resource.title"
        }
      },
      "is BambooHR WWW Microsite": {
        "modulePath": "core/src/lib/dataElements/customCode.js",
        "settings": {
          "source": function(event) {
            return (/^(localhost(:\d+)?|.*--bamboohr-website--hlxsites\.hlx\.page|www\.bamboohr\.com)$/i.test(document.location.hostname) && !_satellite.getVar("is BambooHR Ancillary Microsite"));
          }
        }
      },
      "is TrustArc Advertising Cookie Allowed": {
        "modulePath": "core/src/lib/dataElements/customCode.js",
        "settings": {
          "source": function(event) {
            var noticeGDPRPrefs = _satellite.cookie.get("notice_gdpr_prefs");
            var noticeBehavior = _satellite.cookie.get("notice_behavior");

            if (!noticeGDPRPrefs && noticeBehavior && noticeBehavior != "expressed|eu")
              return true;
            else if (noticeGDPRPrefs) {
              if (/^.*2.*$/i.test(noticeGDPRPrefs))
                return true;
              else
                return false;
            }
      ...
      "Blog Post Read Time": {
        ...
        "modulePath": "core/src/lib/dataElements/javascriptVariable.js",
        "settings": {
          "path": "digitalData.resource.readTime"
        }
      },
      "is TrustArc Functional Cookie Allowed": {
        "modulePath": "core/src/lib/dataElements/customCode.js",
        "settings": {
          "source": function(event) {
            var noticeGDPRPrefs = _satellite.cookie.get("notice_gdpr_prefs");
      ...
      "is BambooHR Site": {
        ...
        "settings": {
          "source": function(event) {
            return (/^(localhost(:\d+)?|.*--bamboohr-website--hlxsites\.hlx\.page|www\.bamboohr\.com)$i/.test(document.location.hostname));
          }
        }
      },
      "Adobe Tags Environment Stage": {
        "modulePath": "core/src/lib/dataElements/runtimeEnvironment.js",
        "settings": {
          "attribute": "environmentStage"
        }
      },
      "is BambooHR Partners Microsite": {
        "modulePath": "core/src/lib/dataElements/customCode.js",
        "settings": {
          "source": function(event) {
            return (/^partners\.bamboohr\.com$/i.test(document.location.hostname));
          }
        }
      },
      "Referrer": {
      ...
      "Campaign": {
        ...
        "settings": {
          "source": function(event) {
            var campaign = (s.Util.getQueryParam("utm_campaign") || "not_set") + "|" + (s.Util.getQueryParam("utm_source") || "not_set") + "|" + (s.Util.getQueryParam("utm_medium") || "not_set") + "|" + (s.Util.getQueryParam("utm_term") || "not_set") + "|" + (s.Util.getQueryParam("utm_content") || "not_set");
      ...
      "Blog Post Author": {
        ...
        "modulePath": "core/src/lib/dataElements/javascriptVariable.js",
        "settings": {
          "path": "digitalData.resource.author"
        }
      },
      "Page Name": {
        "modulePath": "core/src/lib/dataElements/customCode.js",
        "settings": {
          "source": function(event) {
            /*
   Assumes the Page Name is built strictly off of the URL structure in the format "bhr|site-name|path|page" and pages end in ".html", "/", or a character
*/

            var hostNameFirstElement = window.location.hostname.split(".")[0];
            var pageName = "bhr";
            var path = window.location.pathname.replace(/(\.html|\/)$/, "").replaceAll("/", "|");

            if (/^\/blog\/.*$/i.test(window.location.pathname))
              ;
            else if (/^\/integrations\/.*$/i.test(window.location.pathname))
              path = path.replace(/^\|integrations/, "|marketplace");
            else if (/^(localhost|.*--bamboohr-website--hlxsites|www)$/i.test(hostNameFirstElement))
              pageName += "|www";
            else if (/^partners$/i.test(hostNameFirstElement))
              pageName += "|partners";
            else
              pageName += hostNameFirstElement;
      ...
      "is BambooHR Ancillary Microsite": {
        "modulePath": "core/src/lib/dataElements/customCode.js",
        "settings": {
          "source": function(event) {
            return (_satellite.getVar("is BambooHR Blog Microsite") || _satellite.getVar("is BambooHR Marketplace Microsite") || _satellite.getVar("is BambooHR Partners Microsite"));
          }
        }
      },
      "Blog Post Category": {
        ...
        "modulePath": "core/src/lib/dataElements/javascriptVariable.js",
        "settings": {
          "path": "digitalData.resource.category"
        }
      },
      "Blog Post Updated Date": {
        ...
        "modulePath": "core/src/lib/dataElements/javascriptVariable.js",
        "settings": {
          "path": "digitalData.resource.updatedDate"
        }
      },
      "Blog Post Publication Date": {
        ...
        "modulePath": "core/src/lib/dataElements/javascriptVariable.js",
        "settings": {
          "path": "digitalData.resource.publicationDate"
        }
      },
      ...
      "is BambooHR Blog Microsite": {
        "modulePath": "core/src/lib/dataElements/customCode.js",
        "settings": {
          "source": function(event) {
            return (/^\/blog\/.*$/i.test(document.location.pathname));
          }
        }
      },
      "Activity Map Customizer Contextual DOM Attribute": {
        ...
        "settings": {
          "inputParam": {
            ...
            "matchCSSSelector": "*[am-region]",
            "traverseBottomToTop": false
          }
        }
      },
      "Adobe Tags Debug Info": {
        "modulePath": "core/src/lib/dataElements/customCode.js",
        "settings": {
          "source": function(event) {
            return "p=" + _satellite.property.name + ";e=" + _satellite.environment.stage + ";d=" + _satellite.buildInfo.buildDate + (event ? ";r=" + event.$rule.name + ";t=" + event.$type : "");
          }
        }
      },
      "is BambooHR Marketplace Microsite": {
        "modulePath": "core/src/lib/dataElements/customCode.js",
        "settings": {
          "source": function(event) {
            return (/^\/integrations\/.*$/i.test(document.location.pathname));
          }
        }
      }
    },
    "extensions": {
      "adobe-analytics": {
        ...
        "settings": {
          ...
          "customSetup": {
            "source": function(s) {
              //Stop secondary custom link beacon from firing on rules that send an exit link beacon
              s.linkInternalFilters = s.apl(s.linkInternalFilters, "localhost,hlx.page,bamboohr.com,mailto:,facebook.com/bamboohr,facebook.com/sharer/sharer.php,twitter.com/share,twitter.com/bamboohr,instagram.com/bamboohr,linkedin.com/sharing,linkedin.com/company/bamboorhr,youtube.com/user/bamboohr,apps.apple.com/us/app/bamboohr/id587244049,play.google.com/store/apps/details?id=com.mokinetworks.bamboohr");

              s.ActivityMap.regionIDAttribute = "am-region";

              s.linkTrackVars = "eVar1,eVar2,eVar3,eVar4,eVar5,eVar6,eVar7,eVar8,eVar10,events,campaign,channel,server";

              s.usePlugins = true;

              function s_doPlugins(s) {
                s.campaign = _satellite.getVar("Campaign");
                s.channel = _satellite.getVar("Channel");
                s.server = _satellite.getVar("Server");

                s.eVar1 = s.pageName = _satellite.getVar("Page Name");
                ...
                if (s._ppvPreviousPage && s._ppvPreviousPage != "undefined") {
                  s.eVar2 = s._ppvPreviousPage;
                  s.eVar6 = "highestPercentViewed=" + s._ppvHighestPercentViewed + " | initialPercentViewed=" + s._ppvInitialPercentViewed + " | foldsSeen=" + s._ppvFoldsSeen + " | foldsAvailable=" + s._ppvFoldsAvailable;
                }

                s.eVar3 = "D=g";

                if (_satellite.getVar("Session Page View Count") == 1 && !s.linkType)
                  s.eVar4 = "D=g";

                if (s._pltPreviousPage && !s.linkType) {
                  s.eVar5 = s._pltLoadTime;
                  s.events = "event100=" + s._pltLoadTime;
                }

                if (!document.documentMode)
                  s.eVar7 = getTimeParting("America/Denver");
                else
                  s.eVar7 = "Internet Explorer Visitors";

                s.eVar8 = _satellite.getVar("Time Since Last Visit");

                s.eVar10 = _satellite.getVar("Adobe Experience Cloud ID");
              }
          ...
          "trackerProperties": {
            "currencyCode": "USD",
            "trackingServer": "smetrics.bamboohr.com",
            "trackInlineStats": true,
            "trackDownloadLinks": true,
            "trackExternalLinks": true,
            "trackingServerSecure": "smetrics.bamboohr.com",
...
// since DTM supported this method on _satellite.
              ...
              module.exports = function() {
                ...
                var e = function() {
                  ...
                  function p() {
                    ...
                    function t() {
                      E(M), k(de.COMPLETE), S(C.status, C.permissions), s && _.set(C.permissions, {
                        optInCookieDomain: c,
                    ...
                    var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, r = i.doesOptInApply, a = i.previousPermissions, o = i.preOptInApprovals, s = i.isOptInStorageEnabled, c = i.optInCookieDomain, u = i.optInStorageExpiry, l = i.isIabContext, f = i.secureCookie, p = i.sameSiteCookie, g = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, m = g.cookies, h = Ne(a);
                    Fe(h, "Invalid `previousPermissions`!"), Fe(o, "Invalid `preOptInApprovals`!");
                    var _ = d({
                      cookieName: "adobeujs-optin"
                    }, {
                      cookies: m
                    }), C = this, S = le(C), I = _e(), v = Le(h), D = Le(o), b = s ? _.get() : {}, y = {}, A = function(e, t) {
                      return Pe(e) || t && Pe(t) ? de.COMPLETE : de.PENDING;
                    }(v, b), O = function(e, t, n) {
                      var i = ke(he, !r);
                      return r ? Object.assign({}, i, e, t, n) : i;
                    }(D, v, b), M = Ee(O), k = function(e) {
                      return A = e;
                    }, E = function(e) {
                      return O = e;
                    };
                    C.deny = n(!1), C.approve = n(!0), C.denyAll = C.deny.bind(C, he), C.approveAll = C.approve.bind(C, he),
                      C.isApproved = function(t) {
                        return e(t, C.permissions);
                      }, C.isPreApproved = function(t) {
                      return e(t, D);
                    }, C.fetchPermissions = function(e) {
                      var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = t ? C.on(de.COMPLETE, e) : xe;
                      ...
                      if (!e || !e.name || "function" != typeof e.onRegister) throw new Error(Ge);
                      y[e.name] || (y[e.name] = e, e.onRegister.call(e, C));
                    }, C.execute = Ue(y), C.memoizeContent = function(e) {
                      Re(e) && _.set(e, {
                        optInCookieDomain: c,
                        optInStorageExpiry: u,
                        secure: f,
                  ...
                  function m() {
                    ...
                    var e = window;
                    if (e === window.top) return void be.error("__tcfapi not found");
                    for (var t; !t; ) {
                      e = e.parent;
                      try {
                    ...
                    if (!t) return void be.error("__tcfapi not found");
                    var n = {};
                  ...
                  function _() {
                    ...
                    e.fetchConsentData = function(e) {
                      ...
                      t = n;
                      var i = Object.keys(pe), r = function(e, t) {
                    ...
                    var a = function(e) {
                      ...
                      n.add("FETCH_CONSENT_DATA", a), o(function(e, a) {
                        if (a) {
                          var o = Ee(e), s = t.getMemoizedContent("iabConsentHash"), c = De(o.tcString).toString(32);
                          o.consentString = e.tcString, o.hasConsentChangedSinceLastCmpPull = s !== c, r("transparencyAndConsentData", o),
                            t.memoizeContent({
                              iabConsentHash: c
                            });
                        }
                  ...
                  var S, I, v = {
                    ...
                    OPT_OUT: E,
                    SAME_SITE_VALUES: T
                  }, P = L.STATE_KEYS_MAP, w = function(e) {
                    function t() {}
                    function n(t, n) {
                      var i = this;
                      return function() {
                  ...
                  }, R = L.MESSAGES, x = L.ASYNC_API_MAP, N = L.SYNC_API_MAP, F = function() {
                    function e() {}
                    function t(e, t) {
                      var n = this;
                      return function() {
                  ...
                  }), H = (U.isObjectEmpty, U.isValueEmpty, U.getIeVersion, U.isFirefox, U.encodeAndBuildRequest,
                    U.isObject, U.defineGlobalNamespace, U.pluck, U.parseOptOut, U.normalizeBoolean,
                    n), G = L.MESSAGES, B = {
                    0: "prefix",
                    1: "orgID",
                    2: "state"
                    ...
                    this.parse = function(e) {
                      ...
                      var r = e !== i.orgID, a = !t || n.origin !== t, o = -1 === Object.keys(G).indexOf(i.prefix);
                      return r || a || o;
                  ...
                  }, Y = L.MESSAGES, W = function(e, t, n, i) {
                    function r(e) {
                      Object.assign(p, e);
                    }
                    function a(e) {
                    ...
                    function c() {
                      r(new w(n._generateID)), p.getMarketingCloudVisitorID(), p.callbackRegistry.executeAll(p.state, !0),
                        C.removeEventListener("message", u);
                    }
                    function u(e) {
                      if (!h.isInvalid(e)) {
                        var t = h.parse(e);
                        m = !1, C.clearTimeout(p._handshakeTimeout), C.removeEventListener("message", u),
                          r(new F(p)), C.addEventListener("message", o), p.setStateAndPublish(t.state), p.callbackRegistry.hasCallbacks() && s(Y.GETSTATE);
                      }
                    }
                    function l() {
                    ...
                    function d() {
                      C.s_c_in || (C.s_c_il = [], C.s_c_in = 0), p._c = "Visitor", p._il = C.s_c_il, p._in = C.s_c_in,
                        p._il[p._in] = p, C.s_c_in++;
                    }
                    function f() {
                      function e(e) {
                    ...
                    set: function(e, t, n) {
                      var r = i(n, "cookieLifetime"), a = i(n, "expires"), o = i(n, "domain"), s = i(n, "secure"), c = i(n, "sameSite"), u = s ? "Secure" : "", l = c ? "SameSite=" + c + ";" : "";
                    ...
                    remove: function(e, t) {
                      var n = i(t, "domain");
                      n = n ? " domain=" + n + ";" : "";
                      var r = i(t, "secure"), a = i(t, "sameSite"), o = r ? "Secure" : "", s = a ? "SameSite=" + a + ";" : "";
                    ...
                    var i, r = n.split("."), a = t || {};
                    for (i = r.length - 2; i >= 0; i--) if (a.domain = r.slice(i).join("."), Z.set("TEST_AMCV_COOKIE_WRITE", "cookie", a)) return Z.remove("TEST_AMCV_COOKIE_WRITE", a),
                      a.domain;
                    return "";
                  }, te = {
                    compare: s,
                    ...
                    if (1 == e) {
                      for (i += "ABCDEF", t = 0; 16 > t; t++) n = Math.floor(Math.random() * o), 4 > t && l[t] < o && (n = +l[t]),
                        r += i.substring(n, n + 1), n = Math.floor(Math.random() * o), a += i.substring(n, n + 1),
                        o = 16;
                      return r + "-" + a;
                    }
                    for (t = 0; 19 > t; t++) n = Math.floor(Math.random() * s), 6 > t && l[t] < s ? (r += l[t],
                      n = l[t]) : r += i.substring(n, n + 1), 0 === t && 9 == n ? s = 3 : (1 == t || 2 == t) && 10 != s && 2 > n ? s = 10 : 2 < t && (s = 10),
                      n = Math.floor(Math.random() * c), a += i.substring(n, n + 1), 0 === t && 9 == n ? c = 3 : (1 == t || 2 == t) && 10 != c && 2 > n ? c = 10 : 2 < t && (c = 10);
                    return r + a;
                  }, ae = function(e, t) {
                    return {
                      ...
                      fireCORS: function(n, i, r) {
                        function a(e) {
                          var t;
                          try {
                            if ((t = JSON.parse(e)) !== Object(t)) return void o.handleCORSError(n, null, "Response is not JSON");
                          } catch (e) {
                            return void o.handleCORSError(n, e, "Error parsing response as JSON");
                          }
                          try {
                            for (var i = n.callback, r = C, a = 0; a < i.length; a++) r = r[i[a]];
                            r(t);
                          } catch (e) {
                            o.handleCORSError(n, e, "Error forming callback function");
                          }
                        }
                        var o = this;
                        ...
                        try {
                          ...
                          s.open("get", n.corsUrl + "&ts=" + new Date().getTime(), !0), "XMLHttpRequest" === this.corsMetadata.corsType && (s.withCredentials = !0,
                            s.timeout = e.loadTimeout, s.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"),
                            s.onreadystatechange = function() {
                              4 === this.readyState && 200 === this.status && a(this.responseText);
                            }), s.onerror = function(e) {
                            o.handleCORSError(n, e, "onerror");
                          }, s.ontimeout = function(e) {
                            o.handleCORSError(n, e, "ontimeout");
                          }, s.send(), t.fieldGroupObj[r] = {
                            requestStart: t.millis(),
                            url: n.corsUrl,
                            d_visid_stg_timeout_captured: s.timeout,
                            d_settimeout_overriden: t.getSetTimeoutOverriden(),
                            d_visid_cors: 1
                          }, e._log.requests.push(n.corsUrl);
                        } catch (e) {
                    ...
                    return {
                      ...
                      getUrl: function() {
                        ...
                        return this.subdomain || (this.subdomain = "nosubdomainreturned"), e.loadSSL && (i = e.idSyncSSLUseAkamai ? "https://fast." : "https://"),
                          t = i + this.subdomain + ".demdex.net/dest5.html" + r, this.iframeHost = this.getIframeHost(t),
                      ...
                      checkDPIframeSrc: function() {
                        ...
                        "string" == typeof e.dpIframeSrc && e.dpIframeSrc.length && (this.id = "destination_publishing_iframe_" + (e._subdomain || this.subdomain || new Date().getTime()) + "_" + e.idSyncContainerID,
                          this.iframeHost = this.getIframeHost(e.dpIframeSrc), this.url = e.dpIframeSrc + t);
                      },
                      ...
                      attachIframe: function() {
                        function e() {
                          r = n.createElement("iframe"), r.sandbox = "allow-scripts allow-same-origin", r.title = "Adobe ID Syncing iFrame",
                            r.id = i.id, r.name = i.id + "_name", r.style.cssText = "display: none; width: 0; height: 0;",
                            r.src = i.url, i.newIframeCreated = !0, t(), n.body.appendChild(r);
                        }
                        function t(e) {
                          r.addEventListener("load", function() {
                            r.className = "aamIframeLoaded", i.iframeHasLoaded = !0, i.fireIframeLoadedCallbacks(e),
                              i.requestToProcess();
                          });
                        }
                        this.startedAttachingIframe = !0;
                        var i = this, r = n.getElementById(this.id);
                        r ? "IFRAME" !== r.nodeName ? (this.id += "_2", this.iframeIdChanged = !0, e()) : (this.newIframeCreated = !1,
                          "aamIframeLoaded" !== r.className ? (this.originalIframeHasLoadedAlready = !1, t("The destination publishing iframe already exists from a different library, but hadn't loaded yet.")) : (this.originalIframeHasLoadedAlready = !0,
                            this.iframeHasLoaded = !0, this.iframe = r, this.fireIframeLoadedCallbacks("The destination publishing iframe already exists from a different library, and had loaded alresady."),
                      ...
                      requestToProcess: function(t) {
                        ...
                        if (t === Object(t) && t.ibs) if (i = JSON.stringify(t.ibs || []), this.jsonForComparison.length) {
                          var a, o, s, c = !1;
                          for (a = 0, o = this.jsonForComparison.length; a < o; a++) if (s = this.jsonForComparison[a],
                      ...
                      getRegionAndCheckIfChanged: function(t, n) {
                        ...
                        return i ? r && (e._setFieldExpire("MCAAMLH", n), e._setField("MCAAMLH", r), parseInt(i, 10) !== r && (this.regionChanged = !0,
                          this.timesRegionChanged++, e._setField("MCSYNCSOP", ""), e._setField("MCSYNCS", ""),
                          i = r)) : (i = r) && (e._setFieldExpire("MCAAMLH", n), e._setField("MCAAMLH", i)),
                        i || (i = ""), i;
                      },
                      processSyncOnPage: function(e) {
                        var t, n, i, r;
                        if ((t = e.ibs) && t instanceof Array && (n = t.length)) for (i = 0; i < n; i++) r = t[i],
                        r.syncOnPage && this.checkFirstPartyCookie(r, "", "syncOnPage");
                      },
                      process: function(e) {
                        var t, n, i, r, a, o = encodeURIComponent, s = !1;
                        if ((t = e.ibs) && t instanceof Array && (n = t.length)) for (s = !0, i = 0; i < n; i++) r = t[i],
                      ...
                      checkFirstPartyCookie: function(t, n, i) {
                        ...
                        c ? (o = c.split("*"), s = this.pruneSyncData(o, t.id, d), u = s.dataPresent, l = s.dataValid,
                        u && l || this.fireSync(r, t, n, o, a, d)) : (o = [], this.fireSync(r, t, n, o, a, d));
                      },
                      pruneSyncData: function(e, t, n) {
                        var i, r, a, o = !1, s = !1;
                        for (r = 0; r < e.length; r++) i = e[r], a = parseInt(i.split("-")[1], 10), i.match("^" + t + "-") ? (o = !0,
                          n < a ? s = !0 : (e.splice(r, 1), r--)) : n >= a && (e.splice(r, 1), r--);
                        return {
                          dataPresent: o,
                          dataValid: s
                        };
                      ...
                      setSyncTrackingData: function(t, n, i, r) {
                        t.push(n.id + "-" + (r + Math.ceil(n.ttl / 60 / 24))), this.manageSyncsSize(t),
                      ...
                      sendMessages: function() {
                        ...
                        this.regionChanged && (n = i("---destpub-clear-dextp---"), this.regionChanged = !1),
                          this.messages.length ? oe.POST_MESSAGE_ENABLED ? (e = n + i("---destpub-combined---") + this.messages.join("%01"),
                            ...
                            this.postMessage(n + e), setTimeout(function() {
                            t.sendMessages();
                      ...
                      receiveMessage: function(e) {
                        ...
                        "string" == typeof e && n.test(e) && (t = e.replace(n, "").split("|"), "canSetThirdPartyCookies" === t[0] && (this.canSetThirdPartyCookies = "true" === t[1],
                      ...
                      processIDCallData: function(i) {
                        (null == this.url || i.subdomain && "nosubdomainreturned" === this.subdomain) && ("string" == typeof e._subdomain && e._subdomain.length ? this.subdomain = e._subdomain : this.subdomain = i.subdomain || "",
                          this.url = this.getUrl()), i.ibs instanceof Array && i.ibs.length && (this.doAttachIframe = !0),
                  ...
                  }, pe = (S = {}, t(S, fe.AAM, 565), t(S, fe.ECID, 565), S), ge = (I = {}, t(I, fe.AAM, [ 1, 10 ]),
                    t(I, fe.ECID, [ 1, 10 ]), I), me = [ "videoaa", "iabConsentHash" ], he = function(e) {
                  ...
                  }(), be = new ve("[ADOBE OPT-IN]"), ye = function(t, n) {
                    return e(t) === n;
                  }, Ae = function(e, t) {
                    ...
                    return void 0 === e || (Re(e) ? Me(Object.keys(e), !0) : we(e));
                  }, we = function(e) {
                    try {
                      var t = JSON.parse(e);
                      return !!e && ye(e, "string") && Me(Object.keys(t), !0);
                    } catch (e) {
                      return !1;
                    }
                  }, Re = function(e) {
                    ...
                    return function() {
                      ...
                      try {
                        ...
                        be.error("[execute] Something went wrong: " + e.message);
                      }
                    };
                  };
                  f.prototype = Object.create(Error.prototype), f.prototype.constructor = f;
                  var He = "fetchPermissions", Ge = "[OptIn#registerPlugin] Plugin is invalid.";
                  ...
                  var Be = Object.freeze({
                    ...
                    e.publishDestinations = function(n) {
                      ...
                      a.iframe ? (r({
                        ...
                        a.doAttachIframe = !0, a.url = a.getUrl(), a.readyToAttachIframe() ? (a.iframeLoadedCallbacks.push(function(e) {
                        r({
                    ...
                    for (c[c.length] = u / o | 0, c[c.length] = u, r = 0; r < c.length; ) {
                      ...
                      for (l = l.slice(0, 8), i = 0; i < 64; i++) {
                        var _ = m[i - 15], C = m[i - 2], S = l[0], I = l[4], v = l[7] + (n(I, 6) ^ n(I, 11) ^ n(I, 25)) + (I & l[5] ^ ~I & l[6]) + d[i] + (m[i] = i < 16 ? m[i] : m[i - 16] + (n(_, 7) ^ n(_, 18) ^ _ >>> 3) + m[i - 7] + (n(C, 17) ^ n(C, 19) ^ C >>> 10) | 0);
                    ...
                    return "SHA-256" !== t && "SHA256" !== t && "sha256" !== t && "sha-256" !== t || (e = Ye(e)),
                      e;
                  }, Xe = function(e) {
                  ...
                  var Je = function(t, n, i) {
                    ...
                    function a(e) {
                      ...
                      return function(e) {
                        ...
                        try {
                          ...
                          if (i) return Y.parsePipeDelimetedKeyValues(i);
                        } catch (e) {}
                      };
                    }
                    function o(e) {
                      function t(e, t, n) {
                        e && e.match(oe.VALID_VISITOR_ID_REGEX) && (n === T && (y = !0), t(e));
                      }
                      t(e[T], S.setMarketingCloudVisitorID, T), S._setFieldExpire(N, -1), t(e[R], S.setAnalyticsVisitorID);
                    }
                    function s(e) {
                      e = e || {}, S._supplementalDataIDCurrent = e.supplementalDataIDCurrent || "", S._supplementalDataIDCurrentConsumed = e.supplementalDataIDCurrentConsumed || {},
                        S._supplementalDataIDLast = e.supplementalDataIDLast || "", S._supplementalDataIDLastConsumed = e.supplementalDataIDLastConsumed || {};
                    }
                    function c(e) {
                      function t(e, t, n) {
                    ...
                    function d() {
                      return S.configs.doesOptInApply && S.configs.isIabContext ? I.optIn.isApproved(I.optIn.Categories.ECID) && b : I.optIn.isApproved(I.optIn.Categories.ECID);
                    }
                    function f() {
                      [ [ "getMarketingCloudVisitorID" ], [ "setCustomerIDs", void 0 ], [ "syncIdentity", void 0 ], [ "getAnalyticsVisitorID" ], [ "getAudienceManagerLocationHint" ], [ "getLocationHint" ], [ "getAudienceManagerBlob" ] ].forEach(function(e) {
                        var t = e[0], n = 2 === e.length ? e[1] : "", i = S[t];
                        S[t] = function(e) {
                    ...
                    function p() {
                      var e = S._getAudienceManagerURLData(), t = e.url;
                      return S._loadData(E, t, null, e);
                    }
                    function g(e, t) {
                      if (b = !0, e) throw new Error("[IAB plugin] : " + e);
                      t && t.gdprApplies && (v = t.consentString, D = t.hasConsentChangedSinceLastCmpPull ? 1 : 0),
                        p(), _();
                    }
                    function m(e, t) {
                      if (b = !0, e) throw new Error("[IAB plugin] : " + e);
                      t.gdprApplies && (v = t.consentString, D = t.hasConsentChangedSinceLastCmpPull ? 1 : 0),
                        S.init(), _();
                    }
                    function h() {
                    ...
                    var S = this, I = window.adobe, v = "", D = 0, b = !1, y = !1;
                    S.version = "5.5.0";
                    var A = C, O = A.Visitor;
                    O.version = S.version, O.AuthState = L.AUTH_STATE, O.OptOut = L.OPT_OUT, A.s_c_in || (A.s_c_il = [],
                      A.s_c_in = 0), S._c = "Visitor", S._il = A.s_c_il, S._in = A.s_c_in, S._il[S._in] = S,
                      A.s_c_in++, S._instanceType = "regular", S._log = {
                      requests: []
                    ...
                    }), S.cookieDomain = S.useLocalStorage ? "" : ee(null, M), S.loadSSL = !0, S.loadTimeout = 3e4,
                      S.CORSErrors = [], S.marketingCloudServer = S.audienceManagerServer = "dpm.demdex.net",
                      S.sdidParamExpiry = 30;
                    var k = null, E = "MC", T = "MCMID", P = "MCIDTS", w = "A", R = "MCAID", x = "AAM", N = "MCAAMB", F = "NONE", j = function(e) {
                    ...
                    S.FIELDS = L.FIELDS, S.cookieRead = function(e) {
                      ...
                      var r = S.cookieLifetime ? ("" + S.cookieLifetime).toUpperCase() : "", a = {
                        expires: n,
                      ...
                      return S._isAllowedDone || (S._isAllowedDone = !0, (S.cookieRead(S.cookieName) || S.cookieWrite(S.cookieName, "T", 1)) && (S._isAllowedFlag = !0)),
                      "T" === S.cookieRead(S.cookieName) && S.removeCookie(S.cookieName), S._isAllowedFlag;
                      ...
                      var n = S._getAudienceManagerURLData("_setMarketingCloudFields"), i = n.url;
                    ...
                    S.getVisitorValues = function(e, t) {
                    ...
                    }, S._currentCustomerIDs = {}, S._customerIDsHashChanged = !1, S._newCustomerIDsHash = "",
                      S.setCustomerIDs = function(t, n) {
                        if (!S.isOptedOut() && t) {
                          if (!U.isObject(t) || U.isObjectEmpty(t)) return !1;
                          S._readVisitor();
                          var i, a, o, s;
                          for (i in t) if (j(i) && (S._currentCustomerIDs.dataSources = S._currentCustomerIDs.dataSources || {},
                            a = t[i], n = a.hasOwnProperty("hashType") ? a.hashType : n, a)) if ("object" === e(a)) {
                            var c = {};
                            if (a.id) {
                              if (n) {
                          ...
                          var u = S.getCustomerIDs(!0), l = S._getField("MCCIDH"), d = "";
                          l || (l = 0);
                          for (o in u) {
                            var f = u[o];
                            if (!U.isObjectEmpty(f)) for (i in f) j(i) && (a = f[i], d += (d ? "|" : "") + i + "|" + (a.id ? a.id : "") + (a.authState ? a.authState : ""));
                          }
                          S._newCustomerIDsHash = String(S._hash(d)), S._newCustomerIDsHash !== l && (S._customerIDsHashChanged = !0,
                            S._mapCustomerIDs(r));
                        }
                      ...
                      if (!S.isOptedOut() && t) {
                        ...
                        S._readVisitor();
                        var i, a, o, s, c;
                        for (i in t) if (j(i) && (S._currentCustomerIDs.nameSpaces = S._currentCustomerIDs.nameSpaces || {},
                          a = t[i], n = a.hasOwnProperty("hashType") ? a.hashType : n, a && "object" === e(a))) {
                          var u = {};
                          if (a.id) {
                            if (n) {
                          ...
                          void 0 != a.authState && (u.authState = a.authState), a.dataSource && (S._currentCustomerIDs.dataSources = S._currentCustomerIDs.dataSources || {},
                            s = a.dataSource, S._currentCustomerIDs.dataSources[s] = u), S._currentCustomerIDs.nameSpaces[i] = u;
                        }
                        var l = S.getCustomerIDs(!0), d = S._getField("MCCIDH"), f = "";
                        d || (d = "0");
                        for (c in l) {
                          var p = l[c];
                          if (!U.isObjectEmpty(p)) for (i in p) j(i) && (a = p[i], f += (f ? "|" : "") + i + "|" + (a.id ? a.id : "") + (a.authState ? a.authState : ""));
                        }
                        S._newCustomerIDsHash = String(S._hash(f)), S._newCustomerIDsHash !== d && (S._customerIDsHashChanged = !0,
                          S._mapCustomerIDs(r));
                      }
                      ...
                      for (t in r) j(t) && (n = r[t], n.id && (i.dataSources[t] || (i.dataSources[t] = {}),
                        i.dataSources[t].id = n.id, void 0 != n.authState ? i.dataSources[t].authState = n.authState : i.dataSources[t].authState = O.AuthState.UNKNOWN,
                      n.hashType && (i.dataSources[t].hashType = n.hashType)));
                      var a = S._currentCustomerIDs.nameSpaces;
                      for (t in a) j(t) && (n = a[t], n.id && (i.nameSpaces[t] || (i.nameSpaces[t] = {}),
                        i.nameSpaces[t].id = n.id, void 0 != n.authState ? i.nameSpaces[t].authState = n.authState : i.nameSpaces[t].authState = O.AuthState.UNKNOWN,
                      ...
                      if (!Y.isTrackingServerPopulated() && !n) return S._callCallback(e, [ "" ]), "";
                      var i = "";
                      if (n || (i = S.getMarketingCloudVisitorID(function(t) {
                        S.getAnalyticsVisitorID(e, !0);
                      })), i || n) {
                        var r = n ? S.marketingCloudServer : S.trackingServer, a = "";
                        S.loadSSL && (n ? S.marketingCloudServerSecure && (r = S.marketingCloudServerSecure) : S.trackingServerSecure && (r = S.trackingServerSecure));
                        var o = {};
                        if (r) {
                          var s = "http" + (S.loadSSL ? "s" : "") + "://" + r + "/id", c = S.configs.cookieLifetime, u = "d_visid_ver=" + S.version + "&mcorgid=" + encodeURIComponent(S.marketingCloudOrgID) + (i ? "&mid=" + encodeURIComponent(i) : "") + (c ? "&cl=" + encodeURIComponent(c) : "") + (S.idSyncDisable3rdPartySyncing || S.disableThirdPartyCookies ? "&d_coppa=true" : ""), l = [ "s_c_il", S._in, "_set" + (n ? "MarketingCloud" : "Analytics") + "Fields" ];
                          a = s + "?" + u + "&callback=s_c_il%5B" + S._in + "%5D._set" + (n ? "MarketingCloud" : "Analytics") + "Fields",
                            o.corsUrl = s + "?" + u, o.callback = l;
                        }
                        return o.url = a, S._getRemoteField(n ? T : R, a, e, t, o);
                      }
                      return "";
                      ...
                      if (S.getMarketingCloudVisitorID(function(t) {
                        ...
                        var n = S._getField(R);
                        if (!n && Y.isTrackingServerPopulated() && (n = S.getAnalyticsVisitorID(function(t) {
                          S.getAudienceManagerLocationHint(e, !0);
                        })), n || !Y.isTrackingServerPopulated()) {
                          var i = S._getAudienceManagerURLData(), r = i.url;
                      ...
                      return "";
                    }, S._supplementalDataIDCurrent = "", S._supplementalDataIDCurrentConsumed = {},
                      S._supplementalDataIDLast = "", S._supplementalDataIDLastConsumed = {}, S.getSupplementalDataID = function(e, t) {
                      ...
                      return S._supplementalDataIDLast && !S._supplementalDataIDLastConsumed[e] ? (n = S._supplementalDataIDLast,
                        ...
                        S._supplementalDataIDLastConsumed = S._supplementalDataIDCurrentConsumed, S._supplementalDataIDCurrent = n = t ? "" : S._generateID(1),
                        S._supplementalDataIDCurrentConsumed = {}), n && (S._supplementalDataIDCurrentConsumed[e] = !0)),
                        n;
                    };
                    var G = !1;
                    S._liberatedOptOut = null, S.getOptOut = function(e, t) {
                      ...
                      if (S._registerCallback("liberatedOptOut", e), null !== S._liberatedOptOut) return S._callAllCallbacks("liberatedOptOut", [ S._liberatedOptOut ]),
                        G = !1, S._liberatedOptOut;
                      if (G) return null;
                      G = !0;
                      var r = "liberatedGetOptOut";
                      return n.corsUrl = n.corsUrl.replace(/\.demdex\.net\/id\?/, ".demdex.net/optOutStatus?"),
                        n.callback = [ r ], C[r] = function(e) {
                        if (e === Object(e)) {
                        ...
                        S._callAllCallbacks("liberatedOptOut", [ t ]), G = !1;
                      }, V.fireCORS(n), null;
                    ...
                    S.onReceiveEcid = function(e) {
                      ...
                      var t, n, i = 0;
                      if (e) for (t = 0; t < e.length; t++) n = e.charCodeAt(t), i = (i << 5) - i + n,
                        i &= i;
                      return i;
                      ...
                      t && (null == S._callbackList && (S._callbackList = {}), void 0 == S._callbackList[e] && (S._callbackList[e] = []),
                      ...
                      var r = encodeURIComponent(t) + "=" + encodeURIComponent(n), a = Y.parseHash(e), o = Y.hashlessUrl(e);
                      if (-1 === o.indexOf("?")) return o + "?" + r + a;
                      var s = o.split("?"), c = s[0] + "?", u = s[1];
                      return c + Y.addQueryParamAtLocation(u, r, i) + a;
                    }, S._extractParamFromUri = function(e, t) {
                      var n = new RegExp("[\\?&#]" + t + "=([^&#]*)"), i = n.exec(e);
                      if (i && i.length) return decodeURIComponent(i[1]);
                    }, S._parseAdobeMcFromUrl = a(oe.ADOBE_MC), S._parseAdobeMcSdidFromUrl = a(oe.ADOBE_MC_SDID),
                      S._attemptToPopulateSdidFromUrl = function(e) {
                        var n = S._parseAdobeMcSdidFromUrl(e), i = 1e9;
                        n && n.TS && (i = Y.getTimestampInSeconds() - n.TS), n && n.SDID && n.MCORGID === t && i < S.sdidParamExpiry && (S._supplementalDataIDCurrent = n.SDID,
                          S._supplementalDataIDCurrentConsumed.SDID_URL_PARAM = !0);
                      }, S._attemptToPopulateIdsFromUrl = function() {
                      var e = S._parseAdobeMcFromUrl();
                      if (e && e.TS) {
                        var n = Y.getTimestampInSeconds(), i = n - e.TS;
                      ...
                      if (e) try {
                        if (e = function(e) {
                          ...
                          !function(e) {
                            Y.isObject(e) && S.setCustomerIDs(e);
                      ...
                      t = S._addQuerystringParam(t, "d_fieldgroup", e, 1), i.url = S._addQuerystringParam(i.url, "d_fieldgroup", e, 1),
                        i.corsUrl = S._addQuerystringParam(i.corsUrl, "d_fieldgroup", e, 1), K.fieldGroupObj[e] = !0,
                      ...
                      if (!S._settingsDigest) {
                        var e = S.version;
                        S.audienceManagerServer && (e += "|" + S.audienceManagerServer), S.audienceManagerServerSecure && (e += "|" + S.audienceManagerServerSecure),
                      ...
                      if (!S._readVisitorDone) {
                        ...
                        if (c || y || S.discardTrackingServerECID || (c = S.cookieRead(oe.FIRST_PARTY_SERVER_COOKIE)),
                        null == S._fields && (S._fields = {}), c && "T" !== c) for (c = c.split("|"), c[0].match(/^[\-0-9]+$/) && (parseInt(c[0], 10) !== o && (s = !0),
                          c.shift()), c.length % 2 == 1 && c.pop(), e = 0; e < c.length; e += 2) t = c[e].split("-"),
                          n = t[0], i = c[e + 1], t.length > 1 ? (r = parseInt(t[1], 10), a = t[1].indexOf("s") > 0) : (r = 0,
                          a = !1), s && ("MCCIDH" === n && (i = ""), r > 0 && (r = u.getTime() / 1e3 - 60)),
                        n && i && (S._setField(n, i, 1), r > 0 && (S._fields["expire" + n] = r + (a ? "s" : ""),
                        (u.getTime() >= 1e3 * r || a && !S.cookieRead(S.sessionCookieName)) && (S._fieldsExpired || (S._fieldsExpired = {}),
                          S._fieldsExpired[n] = !0)));
                        !S._getField(R) && Y.isTrackingServerPopulated() && (c = S.cookieRead("s_vi")) && (c = c.split("|"),
                        c.length > 1 && c[0].indexOf("v1") >= 0 && (i = c[1], e = i.indexOf("["), e >= 0 && (i = i.substring(0, e)),
                        i && i.match(oe.VALID_VISITOR_ID_REGEX) && S._setField(R, i)));
                      }
                    }, S._appendVersionTo = function(e) {
                      var t = "vVersion|" + S.version, n = e ? S._getCookieVersion(e) : null;
                      ...
                      for (e in S._fields) j(e) && S._fields[e] && "expire" !== e.substring(0, 6) && (t = S._fields[e],
                      ...
                      var i = new Date();
                      i.setTime(i.getTime() + 1e3 * t), null == S._fields && (S._fields = {}), S._fields["expire" + e] = Math.floor(i.getTime() / 1e3) + (n ? "s" : ""),
                        t < 0 ? (S._fieldsExpired || (S._fieldsExpired = {}), S._fieldsExpired[e] = !0) : S._fieldsExpired && (S._fieldsExpired[e] = !1),
                      ...
                      t && "NOTARGET" === (t = t.toUpperCase()) && (t = F), t && (t === F || t.match(oe.VALID_VISITOR_ID_REGEX)) || (t = "")),
                        t;
                    }, S._setFields = function(t, n) {
                      if (S._clearTimeout(t), null != S._loading && (S._loading[t] = !1), X.fieldGroupObj[t] && (X.fieldGroupObj[t].requestEnd = X.millis(),
                        X.process(t)), K.fieldGroupObj[t] && K.setState(t, !1), t === E) {
                        !0 !== K.isClientSideMarketingCloudVisitorID && (K.isClientSideMarketingCloudVisitorID = !1);
                        var i = S._getField(T);
                        if (!i || S.overwriteCrossDomainMCIDAndAID) {
                          if (!(i = "object" === e(n) && n.mid ? n.mid : S._findVisitorID(n))) {
                            if (S._use1stPartyMarketingCloudServer && !S.tried1stPartyMarketingCloudServer) return S.tried1stPartyMarketingCloudServer = !0,
                              void S.getAnalyticsVisitorID(null, !1, !0);
                            i = S._generateLocalMID();
                          }
                          S._setField(T, i);
                        }
                        i && i !== F || (i = ""), "object" === e(n) && ((n.d_region || n.dcs_region || n.d_blob || n.blob) && S._setFields(x, n),
                        S._use1stPartyMarketingCloudServer && n.mid && S._setFields(w, {
                          id: n.id
                      ...
                      if (t === x && "object" === e(n)) {
                        ...
                        var o = S._getField(N);
                        (n.d_blob || n.blob) && (o = n.d_blob, o || (o = n.blob), S._setFieldExpire(N, r),
                          S._setField(N, o)), o || (o = ""), S._callAllCallbacks(N, [ o ]), !n.error_msg && S._newCustomerIDsHash && S._setField("MCCIDH", S._newCustomerIDsHash);
                      }
                      if (t === w) {
                        var s = S._getField(R);
                        s && !S.overwriteCrossDomainMCIDAndAID || (s = S._findVisitorID(n), s ? s !== F && S._setFieldExpire(N, -1) : s = F,
                          S._setField(R, s)), s && s !== F || (s = ""), S._callAllCallbacks(R, [ s ]);
                      }
                      ...
                      if (n === Object(n)) {
                        ...
                        u = f.optOut, l = f.d_ottl, S._setFieldExpire("MCOPTOUT", l, !0), S._setField("MCOPTOUT", u),
                          S._callAllCallbacks("MCOPTOUT", [ u ]);
                      }
                    }, S._loading = null, S._getRemoteField = function(e, t, n, i, r) {
                      var a, o = "", s = Y.isFirstPartyAnalyticsVisitorIDCall(e), c = {
                        MCAAMLH: !0,
                        MCAAMB: !0
                      };
                      if (d() && S.isAllowed()) {
                        ...
                        if (function() {
                          ...
                          if (e === T || "MCOPTOUT" === e ? a = E : "MCAAMLH" === e || e === N ? a = x : e === R && (a = w),
                            a) return !t || null != S._loading && S._loading[a] || (null == S._loading && (S._loading = {}),
                            S._loading[a] = !0, a === x && (D = 0), S._loadData(a, t, function(t) {
                            if (!S._getField(e)) {
                              X.fieldGroupObj[a] && (X.fieldGroupObj[a].timeout = X.millis(), X.fieldGroupObj[a].isActualTimeout = !!t,
                                X.process(a)), t && K.setState(a, !0);
                              var n = "";
                        ...
                        } else o || (e === T ? (S._registerCallback(e, n), o = S._generateLocalMID(), S.setMarketingCloudVisitorID(o)) : e === R ? (S._registerCallback(e, n),
                          o = "", S.setAnalyticsVisitorID(o)) : (o = "", i = !0));
                      }
                      return e !== T && e !== R || o !== F || (o = "", i = !0), n && i && S._callCallback(n, [ o ]),
                      e === T && B.subscribed && (B.callbacks && B.callbacks.length && B.callbacks.forEach(function(e) {
                        S._callCallback(e, [ o ]);
                      ...
                      S._readVisitor(), S._setFields(w, e);
                    }, S._setAudienceManagerFields = function(e) {
                      S._readVisitor(), S._setFields(x, e);
                    }, S._getAudienceManagerURLData = function(e) {
                      var t = S.audienceManagerServer, n = "", i = S._getField(T), r = S._getField(N, !0), a = S._getField(R), o = a && a !== F ? "&d_cid_ic=AVID%01" + encodeURIComponent(a) : "";
                      ...
                      try {
                        var t = [ [ T, S._getField(T) ], [ R, S._getField(R) ], [ "MCORGID", S.marketingCloudOrgID ] ];
                        return S._addQuerystringParam(e, oe.ADOBE_MC, c(t));
                      } catch (t) {
                        return e;
                      }
                    }, S.appendSupplementalDataIDTo = function(e, t) {
                      if (!(t = t || S.getSupplementalDataID(Y.generateRandomString(), !0))) return e;
                      try {
                    ...
                    var X = {
                      d_timingapi: A.performance && A.performance.timing ? 1 : 0,
                      performanceTiming: A.performance && A.performance.timing ? A.performance.timing : null,
                      windowLoad: null,
                      d_winload: null,
                      fieldGroupObj: {},
                      metricsQueue: [],
                      send: function(e) {
                        if (S.takeTimeoutMetrics && e === Object(e)) {
                          var t, n, i = [], r = encodeURIComponent;
                          for (t in e) e.hasOwnProperty(t) && i.push(r(t) + "=" + r(e[t]));
                          n = "http" + (S.loadSSL ? "s" : "") + "://dpm.demdex.net/event?d_visid_ver=" + S.version + "&d_visid_stg_timeout=" + S.loadTimeout + "&" + i.join("&") + "&d_orgid=" + r(S.marketingCloudOrgID) + "&d_timingapi=" + this.d_timingapi + "&d_winload=" + this.getWinLoad() + "&d_ld=" + this.millis(),
                            new Image().src = n, S.timeoutMetricsLog.push(n);
                        }
                      },
                      getWinLoad: function() {
                        return null == this.d_winload && (this.performanceTiming ? this.d_winload = this.windowLoad - this.performanceTiming.navigationStart : this.d_winload = this.windowLoad - O.codeLoadEnd),
                          this.d_winload;
                      },
                      millis: function() {
                      ...
                      process: function(e) {
                        var t = this.fieldGroupObj[e], n = {};
                        n.d_visid_stg_timeout_captured = t.d_visid_stg_timeout_captured, n.d_visid_cors = t.d_visid_cors,
                          n.d_fieldgroup = e, n.d_settimeout_overriden = t.d_settimeout_overriden, t.timeout ? t.isActualTimeout ? (n.d_visid_timedout = 1,
                          n.d_visid_timeout = t.timeout - t.requestStart, n.d_visid_response = -1) : (n.d_visid_timedout = "n/a",
                          n.d_visid_timeout = "n/a", n.d_visid_response = "n/a") : (n.d_visid_timedout = 0,
                          n.d_visid_timeout = -1, n.d_visid_response = t.requestEnd - t.requestStart), n.d_visid_url = t.url,
                          O.windowLoaded ? this.send(n) : this.metricsQueue.push(n), delete this.fieldGroupObj[e];
                      },
                      releaseMetricsQueue: function() {
                        for (var e = 0, t = this.metricsQueue.length; e < t; e++) this.send(this.metricsQueue[e]);
                      },
                      getSetTimeoutOverriden: function() {
                        return "function" == typeof setTimeout.toString ? setTimeout.toString().indexOf("[native code]") > -1 ? 0 : 1 : -1;
                      }
                    };
                    S._timeoutMetrics = X;
                    var K = {
                    ...
                    S.isClientSideMarketingCloudVisitorID = function() {
                      ...
                      if (!S.isOptedOut()) {
                        ...
                        return r = r.replace(/^https:/, "").replace(/^http:/, ""), n = U.encodeAndBuildRequest([ "", e.dpid, e.dpuuid || "" ], ","),
                          i = [ "ibs", a(e.dpid), "img", a(r), t.ttl, "", n ], o.addMessage(i.join("|")),
                          o.requestToProcess(), "Successfully queued";
                      }
                    }, S.idSyncByDataSource = function(e) {
                      if (!S.isOptedOut()) return e === Object(e) && "string" == typeof e.dpuuid && e.dpuuid.length ? (e.url = "//dpm.demdex.net/ibs:dpid=" + e.dpid + "&dpuuid=" + e.dpuuid,
                        S.idSyncByURL(e)) : "Error: config or config.dpuuid is empty";
                    }, qe(S, W), S._getCookieVersion = function(e) {
                      ...
                      if (S.configs = Object.create(null), Y.isObject(n)) for (var e in n) j(e) && (S[e] = n[e],
                        S.configs[e] = n[e]);
                    }(), f();
                    var J;
                    S.init = function() {
                      l() && (I.optIn.fetchPermissions(h, !0), !I.optIn.isApproved(I.optIn.Categories.ECID)) || J || (J = !0,
                        function() {
                          if (Y.isObject(n)) {
                            S.idSyncContainerID = S.idSyncContainerID || 0, k = "boolean" == typeof S.isCoopSafe ? S.isCoopSafe : Y.parseBoolean(S.isCoopSafe),
                            S.resetBeforeVersion && S._resetAmcvCookie(S.resetBeforeVersion), S._attemptToPopulateIdsFromUrl(),
                              S._attemptToPopulateSdidFromUrl(), S._readVisitor();
                            var e = S._getField(P), t = Math.ceil(new Date().getTime() / oe.MILLIS_PER_DAY);
                            S.idSyncDisableSyncs || S.disableIdSyncs || !W.canMakeSyncIDCall(e, t) || (S._setFieldExpire(N, -1),
                              S._setField(P, t)), S.getMarketingCloudVisitorID(), S.getAudienceManagerLocationHint(),
                              S.getAudienceManagerBlob(), S._mergeServerState(S.serverState);
                        ...
                        if (!S.idSyncDisableSyncs && !S.disableIdSyncs) {
                          ...
                          A.addEventListener("load", function() {
                            O.windowLoaded = !0, X.windowLoad = X.millis(), X.releaseMetricsQueue(), e();
                          });
                          try {
                  ...
                  var ze = Je, Qe = function(e) {
                    if (U.isObject(e)) return Object.keys(e).filter(function(t) {
                      return "" !== e[t] && ue.getConfigs()[t];
                    }).reduce(function(t, n) {
                      var i = ue.normalizeConfig(n, e[n]), r = U.normalizeBoolean(i);
                      return t[n] = r, t;
                    }, Object.create(null));
                  }, $e = Be.OptIn, Ze = Be.IabPlugin;
                  return ze.getInstance = function(e, t) {
                    ...
                    !function(e) {
                      C.adobe.optIn = C.adobe.optIn || function() {
                        var t = U.pluck(e, [ "doesOptInApply", "previousPermissions", "preOptInApprovals", "isOptInStorageEnabled", "optInStorageExpiry", "isIabContext", "sameSiteCookie", "secureCookie" ]), n = e.optInCookieDomain || e.cookieDomain;
                    ...
                    var r = e, a = r.split("").reverse().join(""), o = new ze(e, null, a);
      ...
      "common-analytics-plugins": {
        ...
        "hostedLibFilesBaseUrl": "https://assets.adobedtm.com/extensions/EP88bc9a95368c457498f7139d263446ba/",
        "settings": {
          "ns": {
            "id": "ns",
            "obj": "window",
          ...
          "cleanStr": {
            "id": "cs",
            "obj": "window",
            "desc": "Remove unnecessary characters from a string (or string variable), including HTML tag characters, Extra whitespaces (including double spaces), Left/right single quotes (â€˜â€™) (replaced with straight single quotes), Tabs, Newlines/Carriage Returns. ",
            "name": "Clean String",
            "display": true,
            "version": "2.0",
            "depricated": false
        ...
        "modules": {
          "common-analytics-plugins/src/lib/actions/initialize.js": {
            ...
            "script": function(module, exports, require, turbine) {
              ...
              var initMany = require('./common').initMany;

              module.exports = function( settings ) {
                var si = settings, parray = [];

                //turbine.logger.error( JSON.stringify( si, null, '\t' ) );

                // plugins referenced by other plugins
                si.il   = si.il   || si.ft   || si.apl  || si.gtbe || si.gttc? true: false;
                si.pt   = si.pt   || si.gqp  || si.mv?                         true: false;
                si.ft   = si.ft   || si.gtbe || si.gttc?                       true: false;
                si.p_fo = si.p_fo || si.fpo  || si.gplt || si.gppv?            true: false;
                si.apl  = si.apl  || si.ape?                                   true: false;

                if( si.ns ) {
                  parray.push( { pname: 'zeroPad',               obj: 'window' }    );
                  parray.push( { pname: 'randomNumber',          obj: 'window' }    );
                  parray.push( { pname: 'twoDecimals',           obj: 'window' }    )
                }
                if( si.ggc ) {
                  parray.push( { pname: 'getGeoCoordinates',     obj: 'window'    } );
                  parray.push( { pname: 'getGeoCoordinates',     obj: 'analytics' } );
                }
                if( si.gnr ) {
                  parray.push( { pname: 'getNewRepeat',          obj: 'window'    } );
                  parray.push( { pname: 'getNewRepeat',          obj: 'analytics' } );
                }
                if( si.gpn )   parray.push( { pname: 'getPageName',           obj: 'window' }    );
                if( si.gnr )   parray.push( { pname: 'getTimeParting',        obj: 'window' }    );
                if( si.grl )   parray.push( { pname: 'getResponsiveLayout',   obj: 'window' }    );

                if( si.il )    parray.push( { pname: 'inList',                obj: 'analytics' } );
                if( si.ft )    parray.push( { pname: 'formatTime',            obj: 'analytics' } );
                if( si.pt )    parray.push( { pname: 'pt',                    obj: 'analytics' } );
                if( si.p_fo )  parray.push( { pname: 'p_fo',                  obj: 'analytics' } );
                if( si.apv )   parray.push( { pname: 'addProductEvar',        obj: 'analytics' } );
                if( si.ape )   parray.push( { pname: 'addProductEvent',       obj: 'analytics' } );
                if( si.apl )   parray.push( { pname: 'apl',                   obj: 'analytics' } );
                if( si.rfl )   parray.push( { pname: 'rfl',                   obj: 'analytics' } );
                if( si.gvo )   parray.push( { pname: 'getValOnce',            obj: 'analytics' } );
                if( si.gpv )   parray.push( { pname: 'getPreviousValue',      obj: 'analytics' } );
                if( si.gapv )  parray.push( { pname: 'getAndPersistValue',    obj: 'analytics' } );
                if( si.gtslv ) parray.push( { pname: 'getTimeSinceLastVisit', obj: 'analytics' } );
                if( si.gdslv ) parray.push( { pname: 'getDaysSinceLastVisit', obj: 'analytics' } );
                if( si.gqp )   parray.push( { pname: 'getQueryParam',         obj: 'analytics' } );
                if( si.gtbe )  parray.push( { pname: 'getTimeBetweenEvents',  obj: 'analytics' } );
                if( si.gtp )   parray.push( { pname: 'getTimeParting',        obj: 'window'    } );
                if( si.gttc )  parray.push( { pname: 'getTimeToComplete',     obj: 'analytics' } );
                if( si.gvd ) {
                  parray.push( { pname: 'getVisitDuration',      obj: 'window'    } );
                  parray.push( { pname: 'getVisitDuration',      obj: 'analytics' } );
                }
                if( si.gvn ) {
                  parray.push( { pname: 'getVisitNum',           obj: 'analytics' } );
                  parray.push( { pname: 'getVisitNum',           obj: 'window'    } );
                  parray.push( { pname: 'endOfDatePeriod',       obj: 'window'    } );
                }
                if( si.gplt ) {
                  parray.push( { pname: 'getPageLoadTime',       obj: 'analytics' } );
                  parray.push( { pname: 'performanceWriteFull',  obj: 'analytics' } );
                  parray.push( { pname: 'performanceWritePart',  obj: 'analytics' } );
                  parray.push( { pname: 'performanceCheck',      obj: 'analytics' } );
                }
                if( si.mv ) {
                  parray.push( { pname: 'manageVars',            obj: 'analytics' } );
                  parray.push( { pname: 'lowerCaseVars',         obj: 'analytics' } );
                }
                if( si.cs ) {
                  parray.push( { pname: 'cleanStr',              obj: 'analytics' } );
                  parray.push( { pname: 'cleanStr',              obj: 'window'    } )
                }
                if( si.gppv ) {
                  parray.push( { pname: 'getPercentPageViewed',  obj: 'analytics' } );
                  parray.push( { pname: 'handlePPVevents',       obj: 'analytics' } )
                }

                //turbine.logger.error (parray);
...
// other lifecycle event types.
      ...
      "activity-map-customizer": {
        ...
        "hostedLibFilesBaseUrl": "https://assets.adobedtm.com/extensions/EPfd661e49f48a42f18b6e5e93a993b11e/",
        "modules": {
          "activity-map-customizer/src/lib/dataElements/linkClickRegionPath.js": {
            ...
            "script": function(module, exports, require, turbine) {
               ...
               */
              var getParents = function (elem, selector,traverseBottomToTop) {
              ...
              function evaluateAndGrabValues(el, captureParam) {
                var elemPaths = [];
                var allMatchingElements = [];

                if (captureParam.matchCriteria === 'self') {
                  var closestMatch = getClosest(el, captureParam.matchCSSSelector);
                  if (closestMatch == el) {
                    allMatchingElements.push(closestMatch);
                  }
                } else if (captureParam.matchCriteria === 'ancestors') {
                  allMatchingElements = getParents(el.parentNode, captureParam.matchCSSSelector,captureParam.traverseBottomToTop);
                } else if (captureParam.matchCriteria === 'self-ancestors') {
                  allMatchingElements = getParents(el, captureParam.matchCSSSelector,captureParam.traverseBottomToTop);
                }
                for (var i = 0; i < allMatchingElements.length; i++) {
                  if (allMatchingElements[i].getAttribute(captureParam.grabAttr)) {
                    elemPaths.push(allMatchingElements[i].getAttribute(captureParam.grabAttr));
                  }
                }
                return elemPaths;
              }
...
//     'grabCriteria': grabCriteria,
//     'matchCSSSelector': matchCSSSelector,
//     'grabAttr': grabAttr,
//     'delim': delim
// }
              module.exports = function (settings, event) {
                var dataElemValue = undefined;
                var inputParam = settings.inputParam;

                if (event && event.nativeEvent && (event.nativeEvent.target.nodeName != "" && event.nativeEvent.target.nodeName != "HTML" && event.nativeEvent.target.nodeName != "#document")) {
                  var constructedValue = evaluateAndGrabValues(event.nativeEvent.target, inputParam);
                  if (inputParam.grabCriteria === 'closest') {
                    dataElemValue = constructedValue[0];
                  } else if (inputParam.grabCriteria === 'furthest') {
                    dataElemValue = constructedValue[constructedValue.length - 1];
                  } else if (inputParam.grabCriteria === 'all') {
                    dataElemValue = constructedValue.join(inputParam.delim)
                  }
                }
                else {
                  dataElemValue = _satellite.getVar("linkFinalPath");
                }
          ...
          "activity-map-customizer/src/lib/actions/setvariables.js": {
            ...
            "script": function(module, exports, require, turbine) {
              ...
              function computePriorityLinkValue(confSetting) {
                var finalValue = "";
                //get the first non-null values

                var validPriorityItemsList = confSetting.priorityItems.map(function (p) {
                  //p.deName="closest_data-location";
                  p.keyValue = getDEValue(p.deName, event);
                  return p;
                });

                var validPriorityItems = validPriorityItemsList.filter(function (p) {
                  return p.keyValue != "" && p.keyValue != null && p.keyValue != undefined && p.keyValue != '';
                });

                if (validPriorityItems.length > 0) {
                  finalValue = validPriorityItems[0].keyValue;
                }

                return finalValue;
              }

              function getDEValue(deName, event) {
                return _satellite.getVar(deName, { nativeEvent: event });
              }

              function computeFallbackValue(clickedElement, confSetting) {
                var fallbackVal = "";
                var elemNames = confSetting.fallbackElements.split(',');
                var regionId, className;
                while (clickedElement && (clickedElement = clickedElement.parentNode)) {
                  regionId = clickedElement.tagName;
                  if (regionId) regionId = regionId.toLowerCase();
                  if (regionId && elemNames.indexOf(regionId) > -1) {
                    fallbackVal = regionId;
                    break;
                  }
                }
                return fallbackVal;
              ...
              function computePriorityRegionValue(clickedElement, confSetting) {
                ...
                var fbValue = computeFallbackValue(clickedElement, confSetting);
                if (validPriorityItems.length > 0) {
                  finalValue = validPriorityItems[0].keyValue;
                  if (confSetting.includeFallback && fbValue) {
                    finalValue = fbValue + confSetting.delimiter + finalValue;
                  }
                } else {
                  finalValue = fbValue;
                }
              ...
              function replaceText(inputText, searchMask, replaceMask) {
                if (!inputText) return "";
                var regEx = new RegExp(searchMask, "ig");
                var result = inputText.replace(regEx, replaceMask);
                return result;
              }

              function replaceActivityValueText(section, sectionValue, fieldValues) {
                var finalText = sectionValue;
                fieldValues.forEach(function (fieldItem) {
                  finalText = replaceText(finalText, fieldItem.keyName, fieldItem.keyValue);
                });
                return finalText;
              };

              function applyACMValues(acmSetting, event, sObject) {

                //back up default behaviours
                var _adobeLinkFunc = sObject.ActivityMap.link;
                var _adobeRegionFunc = sObject.ActivityMap.region;

                //link
                if (acmSetting.linkConfig &&
                  ((acmSetting.linkConfig.priorityItems && acmSetting.linkConfig.priorityItems.length > 0) ||
                    (acmSetting.linkConfig.replaceItems && acmSetting.linkConfig.replaceItems.length > 0))
                ) {
                  sObject.ActivityMap.link = function (ele, i) {
                    var linkValue = computePriorityLinkValue(acmSetting.linkConfig);
                    if (!linkValue || linkValue === null || linkValue === "") linkValue = _adobeLinkFunc(ele, i);
                    return replaceActivityValueText("link", linkValue, acmSetting.linkConfig.replaceItems);
                  }
                }
                if (acmSetting.linkConfig.exclude &&
                  acmSetting.linkConfig.exclude.trim().length > 0 ) {
                  sObject.ActivityMap.linkExclusions = acmSetting.linkConfig.exclude;
                }

                //region
                if (acmSetting.regionConfig &&
                  (acmSetting.regionConfig.exclude ||
                    acmSetting.regionConfig.fallbackElements ||
                    (acmSetting.regionConfig.priorityItems && acmSetting.regionConfig.priorityItems.length > 0) ||
                    (acmSetting.regionConfig.replaceItems && acmSetting.regionConfig.replaceItems.length > 0))
                ) {
                  sObject.ActivityMap.region = function (ele) {
                    var regionValue = computePriorityRegionValue(ele, acmSetting.regionConfig);
                    if (!regionValue || regionValue === null || regionValue === "") regionValue = _adobeRegionFunc(ele, sObject.ActivityMap);
                    regionValue = replaceActivityValueText("region", regionValue, acmSetting.regionConfig.replaceItems);
                    var shouldExclude = false;
                    if (acmSetting.regionConfig.exclude &&
                      acmSetting.regionConfig.exclude.trim().length > 0 ) {
                      var excludeArr = acmSetting.regionConfig.exclude.split(',');
                      for (var i = 0; i < excludeArr.length; i++) {
                        if (regionValue.indexOf(excludeArr[i]) > -1) {
                          shouldExclude = true;
                          break;
                        }
                      }
                    }
                    return (shouldExclude === true ? null : regionValue);
                  }
                }
              }

              module.exports = function (settings, event) {
                var acmSetting = settings;//turbine.getExtensionSettings();
                var getTracker = turbine.getSharedModule('adobe-analytics', 'get-tracker');

                getTracker().then(
                  function (tracker) {
                    applyACMValues(acmSetting, event, tracker);
                  }
                );
              };
    ...
    "property": {
      ...
      "id": "PR7f245910d37a458fa16924aecf282f95"
    },
    "rules": [
      {
        "id": "RLcee063e9a92c435ab59fdb60d39321e8",
        "name": "Click | Advertising Cookies | Log In / Partner Login Buttons | All Pages",
        "events": [
          {
            ...
            "settings": {
              ...
              "elementProperties": [
                {
                  "name": "href",
                  "value": "https://app.bamboohr.com/login/"
                }
              ],
          ...
          },
          {
            ...
            "settings": {
              ...
              "elementProperties": [
                {
                  "name": "href",
                  "value": "https://partners.bamboohr.com/login/"
                }
              ],
              "bubbleFireIfParent": true,
              "bubbleFireIfChildFired": true
        ...
        "conditions": [
          {
            ...
            "settings": {
              ...
              "leftOperand": "%is TrustArc Advertising Cookie Allowed%"
            },
            "timeout": 2000
          }
        ],
        "actions": [
            ...
            "settings": {
              "customSetup": {
                "source": function(event, s) {
                  var varsObject = {
                    event1 : [ /app\.bamboohr\.com\/login\//i, undefined, false ],
                    event2 : [ /partners\.bamboohr\.com\/login\//i, undefined, false ]
                  };

                  bhr.analytics.setAdobeAnalyticsVars(varsObject, undefined, this.href, true);
                }
              },
              "trackerProperties": {
              }
          ...
          },
          {
            ...
            "settings": {
              "type": "link",
              "linkName": "Log In button (BambooHR)",
              "linkType": "o"
            },
            "timeout": 2000,
            "delayNext": true
      ...
      {
        "id": "RL309ab629665c4f10af5cbdcc2d7ef667",
        "name": "Data Element Change (is TrustArc Advertising Cookie Allowed) #1 | Advertising Cookies | All Pages",
        "events": [
          {
            "modulePath": "core/src/lib/events/dataElementChange.js",
            "settings": {
              "name": "is TrustArc Advertising Cookie Allowed"
            },
            "ruleOrder": 1.0
          }
        ],
        ...
        "actions": [
          {
            ...
            "settings": {
              "source": 'https://assets.adobedtm.com/ae3ff78e29a2/7f43f668d8a7/0b4982562083/RC61bc16f387104ce9818c85b27a877725-source.js',
              "language": "javascript",
              "isExternal": true
            },
            "timeout": 2000,
      ...
      {
        "id": "RL9cf39c1e23424432a9ece6430864c9ce",
        "name": "Click | Advertising Cookies | Phone Number Dialed | All Pages",
        "events": [
          {
            "modulePath": "core/src/lib/events/click.js",
            "settings": {
      ...
      {
        "id": "RL35a7c9722f334f3bb0ae23bc93a165e4",
        "name": "Library Loaded (Page Top) #1 | All pages",
        "events": [
          {
        ...
        "actions": [
          ...
          },
          {
            "modulePath": "core/src/lib/actions/customCode.js",
            "settings": {
              "source": "if (_satellite.getVar(\"Adobe Tags Environment Stage\") != \"production\") {\n  _satellite.cookie.set(\"notice_gdpr_prefs\", \"0|1|2:\", { expires: 730 });\n  _satellite.cookie.set(\"notice_behavior\", \"implied|na\", { expires: 730 });\n}",
              "language": "javascript"
            },
            "timeout": 2000,
            "delayNext": true
          },
          {
            "modulePath": "core/src/lib/actions/customCode.js",
            "settings": {
              "source": "window.bhr = {\n  analytics : {\n    allVarsObject : {},\n    /**\n     * bhr.analytics.setAdobeAnalyticsVar(varsObject, defaultVarsFunction, testURL, useBeacon)\n     *\n     * Usage:\n     * \n     *  bhr.analytics.setAdobeAnalyticsVars({\n     *      eVar123 : [ /RegEx1-to-match/i, \"value\", false ],\n     *      event123 : [ /RegEx2-to-match/i, undefined, false ]\n     *    }, \n     *    function () { return bhr.analytics.setAdobeAnalyticsDefaultVideoVars(wistiaItem); },\n     *    document.URL,\n     *    false);\n     *\n     * varsObject: object containing key(s) in format eVar(1-250), prop(1-75), or event(1-1000) and value(s) as an array in the format [ RegEx to match on, Value to set (value or undefined), Continue to next eVar (boolean) ]\n     * defaultVarsFunction: a function to set default variables (function or undefined)\n     * testURL: a URL to test the RegEx from the varsObject on\n     * useBeacon: set s.useBeacon = true (boolean)\n     */\n    setAdobeAnalyticsVars : function (varsObject, defaultVarsFunction, testURL, useBeacon) {\n      var allVarsObject = bhr.analytics.allVarsObject = {};\n      \n      s.abort = true;\n      \n      Object.assign(allVarsObject, (typeof defaultVarsFunction === \"function\" ? defaultVarsFunction() : allVarsObject), varsObject);\n      \n      Object.keys(allVarsObject).some(function(element, index, array) {\n        var allVarsObject = bhr.analytics.allVarsObject;\n        var varType;\n        \n        if (/^eVar([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|250)/.test(element))\n          varType = \"eVar\";\n        else if (/^prop([1-9]|[1-6][0-9]|7[0-5])/.test(element))\n          varType = \"prop\";\n        else if (/^event([1-9]|[1-9][0-9]|[1-9][0-9][0-9]|1000)/.test(element))\n          varType = \"event\";\n        else {\n          _satellite.logger.error(\"Invalid element, \" + element + \", passed in allVarsObject in brh.analytics.setAdobeAnalyticsVars\");\n          return false;\n        }\n        \n        if (allVarsObject[element][0].test(testURL)) {\n          if (/^(eVar|prop)$/.test(varType)) {\n            s[element] = allVarsObject[element][1];\n            s.linkTrackVars = s.apl(s.linkTrackVars, element);\n          }\n          else {\n            var value = allVarsObject[element][1];\n            \n            s.events = element + (value ? \"=\" + value : \"\");\n            \n            if (allVarsObject[element][2] == false)\n              s.linkTrackEvents = s.apl(s.linkTrackEvents, element);\n            else\n              s.linkTrackEvents = element;\n          }\n          \n          if (useBeacon == true)\n            s.useBeacon = true;\n          \n          s.abort = false;\n          \n          if (allVarsObject[element][2] == false)\n            return true;\n        }\n      });\n    },\n    /**\n     * setAdobeAnalyticsDefaultWistiaVars(wistiaElement)\n     *\n     * Usage: bhr.analytics.setAdobeAnalyticsDefaultWistiaVars(wistiaItem)\n     *\n     * wistiaItem: object containing the Wistia item\n     */\n    setAdobeAnalyticsDefaultWistiaVars : function (wistiaItem) {\n      return {\n        eVar14 : [ /^((?!podcast).)*$/i, wistiaItem.name(), true ],\n        eVar15 : [ /^((?!podcast).)*$/i, wistiaItem.hashedId(), true ],\n        eVar22 : [ /podcast/i, wistiaItem.name(), true ],\n        eVar23 : [ /podcast/i, wistiaItem.hashedId(), true ]\n      };\n    }\n  }\n}",
              "language": "javascript"
            },
            "timeout": 2000,
            "delayNext": true
          },
          {
            "modulePath": "core/src/lib/actions/customCode.js",
            "settings": {
              "source": "window._wq = window._wq || [];\n_wq.push({ id: \"_all\", onReady: function(wistiaItem) {\n  wistiaItem.bind(\"play\", function() {\n    if (_satellite.getVar(\"is TrustArc Advertising Cookie Allowed\")) {\n      var varsObject = {\n        event6 : [ /^((?!podcast).)*$/i, undefined, false ],\n        event12 : [ /podcast/i, undefined, false ]\n      };\n      var defaultVarsFunction = function () { return bhr.analytics.setAdobeAnalyticsDefaultWistiaVars(wistiaItem); };\n      \n      bhr.analytics.setAdobeAnalyticsVars(varsObject, defaultVarsFunction, document.URL, false);\n      s.tl(true, \"o\", (/podcast/i.test(document.URL) ? \"Podcast\" : \"Video\") + \" Played\");\n    }\n  });\n  \n  wistiaItem.bind('percentwatchedchanged', function (percent, lastPercent) {\n    if (_satellite.getVar(\"is TrustArc Advertising Cookie Allowed\")) {\n      var varsObject;\n      var defaultVarsFunction = function () { return bhr.analytics.setAdobeAnalyticsDefaultWistiaVars(wistiaItem); };\n      \n      if (percent >= .25 && lastPercent < .25) {\n        varsObject = {\n          event7 : [ /^((?!podcast).)*$/i, undefined, false ],\n          event13 : [ /podcast/i, undefined, false ]\n        };\n        \n        bhr.analytics.setAdobeAnalyticsVars(varsObject, defaultVarsFunction, document.URL, false);\n        s.tl(true, \"o\", (/podcast/i.test(document.URL) ? \"Podcast\" : \"Video\") + \" Viewed 25%\");\n      }\n      else if (percent >= .50 && lastPercent < .50) {\n        varsObject = {\n          event8 : [ /^((?!podcast).)*$/i, undefined, false ],\n          event14 : [ /podcast/i, undefined, false ]\n        };\n        \n        bhr.analytics.setAdobeAnalyticsVars(varsObject, defaultVarsFunction, document.URL, false);\n        s.tl(true, \"o\", (/podcast/i.test(document.URL) ? \"Podcast\" : \"Video\") + \" Viewed 50%\");\n      }\n      else if (percent >= .75 && lastPercent < .75) {\n        varsObject = {\n          event9 : [ /^((?!podcast).)*$/i, undefined, false ],\n          event15 : [ /podcast/i, undefined, false ]\n        };\n        \n        bhr.analytics.setAdobeAnalyticsVars(varsObject, defaultVarsFunction, document.URL, false);\n        s.tl(true, \"o\", (/podcast/i.test(document.URL) ? \"Podcast\" : \"Video\") + \" Viewed 75%\");\n      }\n      else if (percent >= .90 && lastPercent < .90) {\n        varsObject = {\n          event10 : [ /^((?!podcast).)*$/i, undefined, false ],\n          event16 : [ /podcast/i, undefined, false ]\n        };\n        \n        bhr.analytics.setAdobeAnalyticsVars(varsObject, defaultVarsFunction, document.URL, false);\n        s.tl(true, \"o\", (/podcast/i.test(document.URL) ? \"Podcast\" : \"Video\") + \" Viewed 90%\");\n      }\n      else if (percent >= 1 && lastPercent < 1) {\n        varsObject = {\n          event11 : [ /^((?!podcast).)*$/i, undefined, false ],\n          event17 : [ /podcast/i, undefined, false ]\n        };\n        \n        bhr.analytics.setAdobeAnalyticsVars(varsObject, defaultVarsFunction, document.URL, false);\n        s.tl(true, \"o\", (/podcast/i.test(document.URL) ? \"Podcast\" : \"Video\") + \" Viewed 100% (Completed)\");\n      }\n    }\n  });\n}});",
              "language": "javascript"
            },
            "timeout": 2000,
            "delayNext": true
      ...
      {
        "id": "RLa7d9a76481dc48fe9f1927700717949d",
        "name": "Data Element Change (Event = Page View) | Advertising Cookies | All Pages",
        "events": [
          {
            "modulePath": "core/src/lib/events/dataElementChange.js",
            "settings": {
          ...
          },
          {
            ...
            "settings": {
              "source": function(event, target) {
                if (_satellite.getVar("has Page View Event Run"))
                  return true;
                else
                  return false;
              }
        ...
        "actions": [
          {
            "modulePath": "core/src/lib/actions/customCode.js",
            "settings": {
              "source": 'https://assets.adobedtm.com/ae3ff78e29a2/7f43f668d8a7/0b4982562083/RC652f84c9869d407b870ce57f4c357016-source.js',
              "language": "javascript",
              "isExternal": true
            },
            "timeout": 2000,
              ...
              "trackerProperties": {
                "eVars": [
                  ...
                  },
                  {
                    "name": "eVar19",
                    "type": "value",
                    "value": "%Blog Post Publication Date%"
                  },
                  {
                    "name": "eVar20",
                    "type": "value",
                    "value": "%Blog Post Updated Date%"
                  },
                  {
                    "name": "eVar21",
                    "type": "value",
                    "value": "%Blog Post Read Time%"
                  },
                  {
                    "name": "eVar200",
                    "type": "value",
                    "value": "%Adobe Tags Debug Info%"
                  }
                ]
              }
            },
          ...
          },
          {
            ...
            "settings": {
              ...
              "regionConfig": {
                ...
                "priorityItems": [
                  {
                    "deName": "Activity Map Customizer Contextual DOM Attribute",
                    "keyName": "%Activity Map Customizer Contextual DOM Attribute%",
                    "keyValue": "%Activity Map Customizer Contextual DOM Attribute%"
                  }
                ],
                "includeFallback": true,
                "fallbackElements": "header,main,footer"
              }
            },
            "timeout": 2000,
            "delayNext": true
          ...
          },
          {
            "modulePath": "core/src/lib/actions/customCode.js",
            "settings": {
              "source": 'https://assets.adobedtm.com/ae3ff78e29a2/7f43f668d8a7/0b4982562083/RCc0d2688dd4d1428a85418a68d8f59ac1-source.js',
              "language": "javascript",
              "isExternal": true
            },
            "timeout": 2000,
      ...
      {
        "id": "RL58fc18798c304135bbc3547803f61769",
        "name": "Click | Advertising Cookies | Mobile App Store Buttons | All Pages",
        "events": [
          {
            "modulePath": "core/src/lib/events/click.js",
            "settings": {
              ...
              "elementProperties": [
                {
                  "name": "href",
                  "value": "https://apps.apple.com/us/app/bamboohr/id587244049"
                }
              ],
              "bubbleFireIfParent": true,
              "bubbleFireIfChildFired": true
          ...
          },
          {
            ...
            "settings": {
              ...
              "elementProperties": [
                {
                  "name": "href",
                  "value": "https://play.google.com/store/apps/details?id=com.mokinetworks.bamboohr"
                }
              ],
              "bubbleFireIfParent": true,
              "bubbleFireIfChildFired": true
        ...
        "actions": [
          {
            ...
            "settings": {
              "customSetup": {
                "source": function(event, s) {
                  var varsObject = {
                    event27 : [ /apps\.apple\.com\/us\/app\/bamboohr\/id587244049/i, undefined, false ],
                    event28 : [ /play\.google\.com\/store\/apps\/details\?id=com\.mokinetworks\.bamboohr/i, undefined, false ]
                  };
      ...
      {
        "id": "RL6b78fb7491774f3fb8cc114b212113d1",
        "name": "Click | Advertising Cookies | Social Media Buttons | All Pages",
        "events": [
          {
            "modulePath": "core/src/lib/events/click.js",
            "settings": {
              "elementSelector": "main div.article-header-share a",
              "bubbleFireIfParent": true,
              "bubbleFireIfChildFired": true
            },
            "ruleOrder": 50.0
          },
          {
            "modulePath": "core/src/lib/events/click.js",
            "settings": {
              "elementSelector": "footer div.social a",
              "bubbleFireIfParent": true,
              "bubbleFireIfChildFired": true
            },
            "ruleOrder": 50.0
        ...
        "actions": [
          {
            ...
            "settings": {
              "customSetup": {
                "source": function(event, s) {
                  var varsObject = {
                    event18 : [ /facebook\.com/i, undefined, false ],
                    event19 : [ /twitter\.com/i, undefined, false ],
                    event20 : [ /instagram\.com/i, undefined, false ],
                    event21 : [ /linkedin\.com/i, undefined, false ],
                    event22 : [ /youtube\.com/i, undefined, false ],
                    event23 : [ /mailto:/i, undefined, false ]
                  };
